...
public class PushMusicListAdapter extends BaseAdapter {

    public PushMusicListAdapter(Context context, List<OnlineMusic> data,boolean mIslandscape) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        if(viewType == Constants.ITEM_VIEW){
            if(islandscape){
                itemView = mInflater.inflate(R.layout.view_holder_push_music_list_land, viewGroup, false);
            } else{
                itemView = mInflater.inflate(R.layout.view_holder_push_music_list_port, viewGroup, false);
            }
            PushMusicListViewHolder viewHolder = new PushMusicListViewHolder(itemView);
            return viewHolder;
        }else{
            ...
            if(mData.isEmpty()){
                //首次加载的loading
                viewHolder.setLoadState(Constants.LOAD_STATE_LOADING);
            }else {
    ...
    public void onBindViewHolder(@NonNull  RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if(viewHolder instanceof  PushMusicListViewHolder){
            PushMusicListViewHolder mViewHolder =  ((PushMusicListViewHolder)viewHolder)  ;
    ...
    class PushMusicListViewHolder extends RecyclerView.ViewHolder {
       private ImageView album_cover;
       private TextView  album_title;
       private TextView  album_artist;
       private View      mItemView;

       public PushMusicListViewHolder(View itemView) {
            super(itemView);
            mItemView = itemView;
