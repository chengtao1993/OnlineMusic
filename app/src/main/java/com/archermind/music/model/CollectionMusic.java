 ...
 */
@Entity(nameInDb = "CollectionMusic")
public class CollectionMusic implements Serializable {
    ...
    private long songId; // [本地]歌曲IDnagelihai
    ...
    @Generated(hash = 200329791)
    public CollectionMusic(Long id, int type, long songId, String title, String artist,
    ...
    public boolean equals(Object o) {
        if (!(o instanceof CollectionMusic)) {
            return false;
        }
        CollectionMusic music = (CollectionMusic) o;
